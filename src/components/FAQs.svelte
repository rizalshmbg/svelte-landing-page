	...
	>
		<div class="flex flex-col gap-2">
			<p class="opacity-60 text-base sm:text-lg md:text-xl text-center">
				For all your <span class="text-indigo-400">questions</span>, qualms &
				queries
			</p>
			<h3
				class="text-4xl sm:text-5xl md:text-6xl max-w-[1000px] mx-auto font-semibold text-center capitalize"
			>
